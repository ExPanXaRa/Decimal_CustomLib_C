...
START_TEST(test_is_greater_or_equal_ok1) {
  // -1
  s21_decimal value_a = {{0x1, 0x0, 0x0, 0x80000000}};
  // 1431655765.00000
  s21_decimal value_b = {{0x5554D320, 0x8235, 0x0, 0x50000}};
  int check = 0;

  s21_assert_is_greater_or_equal(value_a, value_b, check);
}
...
START_TEST(test_is_greater_or_equal_ok14) {
  // 0.9999999999999999999999999999
  s21_decimal value_a = {{0xFFFFFFF, 0x3E250261, 0x204FCE5E, 0x1C0000}};
  // -1
  s21_decimal value_b = {{0x1, 0x0, 0x0, 0x80000000}};
  int check = 1;
...
START_TEST(test_is_greater_or_equal_ok15) {
  ...
  s21_decimal value_a = {{0x1, 0x0, 0x0, 0x80000000}};
  // -0.9999999999999999999999999999
  s21_decimal value_b = {{0xFFFFFFF, 0x3E250261, 0x204FCE5E, 0x801C0000}};
  int check = 0;
...
START_TEST(test_is_greater_or_equal_ok16) {
  // -0.9999999999999999999999999999
  s21_decimal value_a = {{0xFFFFFFF, 0x3E250261, 0x204FCE5E, 0x801C0000}};
  // -1
  s21_decimal value_b = {{0x1, 0x0, 0x0, 0x80000000}};
  int check = 1;
...
START_TEST(test_is_greater_or_equal_ok18) {
  // 0.0000000000000000000000000001
  s21_decimal value_a = {{0x1, 0x0, 0x0, 0x1C0000}};
  // -1
  s21_decimal value_b = {{0x1, 0x0, 0x0, 0x80000000}};
  int check = 1;
...
START_TEST(test_is_greater_or_equal_ok20) {
  // -0.0000000000000000000000000001
  s21_decimal value_a = {{0x1, 0x0, 0x0, 0x801C0000}};
  // -1
  s21_decimal value_b = {{0x1, 0x0, 0x0, 0x80000000}};
  int check = 1;
...
void s21_assert_is_greater_or_equal(s21_decimal value_a, s21_decimal value_b,
                                    int check) {
  int err = s21_is_greater_or_equal(value_a, value_b);
